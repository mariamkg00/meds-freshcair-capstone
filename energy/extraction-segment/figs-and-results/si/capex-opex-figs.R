...
## read in data
cost_data <- read_csv("data/processed/field_capex_opex_forecast_revised.csv")
cost_data_h <- read_csv("data/processed/entry_df_final_revised.csv")

# load historic production
well_prod_org <- fread("data/processed/well_prod_m_processed.csv", colClasses = c('api_ten_digit' = 'character',
...
fwrite(cost_data_h2, 'data/outputs/hist_capex_opex_vals.csv')
