...
calc_excise_ghg <- function(excise_tax_val, scen_z) {
  ...
  # Added year to account for setback starting after 2020 MP
  excise_input_z = excise_input_z[setback_scens, on = .(doc_field_code, setback_scenario, setback_existing, year), nomatch = 0]
...
calc_carbonpx_ghg <- function(carbonpx_val, scen_z) {
  ...
  # Added year to join to account for setback starting after 2020
  carbonpx_input_z = carbonpx_input_z[setback_scens, on = .(doc_field_code, setback_scenario, setback_existing, year), nomatch = 0]
