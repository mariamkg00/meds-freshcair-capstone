...
ica_comp <- bind_rows(ica_comp_ref_cc,ica_comp_ref_solano,ica_comp_ref_la,ica_comp_ref_kern,ica_comp_ref_sb,ica_comp_ref_statewide,
                 ...
                 ica_comp_ext_orange,ica_comp_ext_sb,ica_comp_ext_ventura,ica_comp_ext_statewide)

ica_emp <- bind_rows(ica_emp_ref_cc,ica_emp_ref_solano,ica_emp_ref_la,ica_emp_ref_kern,ica_emp_ref_sb,ica_emp_ref_statewide,
                     ...
                     ica_emp_ext_fresno,ica_emp_ext_kern,ica_emp_ext_la,ica_emp_ext_monterey,
                      ica_emp_ext_orange,ica_emp_ext_sb,ica_emp_ext_ventura,ica_emp_ext_statewide) %>% 
